...
from logic.functions import load_session_state, save_session_state, get_email_user_name
...
for row in query:
    ...
    row[ColName.inspect_link] = f"http://{DOMAIN}/{page_name}?{TARGET_ID_URL_KEY}={row['id']}"  # noqa
...
dynamic_filters = DynamicFilters(df, filters=possible_filters, filters_name=Ck.TARGET_FILTERS)
